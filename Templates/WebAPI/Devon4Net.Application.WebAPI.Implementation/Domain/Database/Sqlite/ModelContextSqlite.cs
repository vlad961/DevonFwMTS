...
{
    public class ModelContextSqlite : DbContext
    {
        public ModelContextSqlite(DbContextOptions<ModelContextSqlite> options)
            : base(options)
        {
        }
        ...
        public ModelContextSqlite(string connectionString)
        {
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Dish>(entity =>
            {
                ...
                entity.Property(e => e.Price).HasColumnType("double(16, 10)");
